...
function TaskSix({ onComplete, onNext }) {
  ...
  const storySteps = [
    {
      question:
        "You find a USB stick on the ground labeled “Executive Salaries 2026.” It looks tempting, but it could be dangerous. What is your first instinct?",
      options: [
    ...
    {
      question:
        "You've brought it to your desk. You're curious about the contents. What do you do next?",
      options: [
        {
          text: "Plug it into your work PC to find the owner",
          impact: "bad",
          score: 0,
        },
        {
          text: "Plug it into a 'disposable' old laptop not on the network",
          impact: "risky",
          score: 0.5,
        },
        {
          text: "Hand it over to the IT Security Team",
          impact: "perfect",
          score: 1,
        },
      ],
  ...
  return (
    <div className="task-content">
      ...
      >
        ...
        >
          Mission: Avoid a real-world hack.
        </p>
        <p style={{ color: "#94a3b8", fontSize: "1rem", lineHeight: "1.5" }}>
          Cyberattacks aren't always digital. <strong>Baiting</strong> relies on
          human curiosity. A single USB drive can contain "HID payloads" that
          trick your computer into thinking a hacker is typing on your keyboard.
        </p>
      </div>
      ...
      {!submitted ? (
        ...
        >
          ...
          >
            💡 Hint: Curiosity killed the network. Think like a Security
            Officer.
          </p>
        </div>
      ) : (
        ...
        >
          ...
          >
            <p style={{ fontSize: "0.9rem", color: "#94a3b8" }}>
              <strong>Expert Review:</strong> Never plug an unknown device into
              any system. Modern "Rubber Ducky" USBs can execute thousands of
              commands per second the moment they are connected, bypassing most
              antivirus software. The only safe move is to hand it to{" "}
              <strong>IT Security</strong> for analysis in a "Sandboxed"
              environment.
            </p>
          </div>
          <div
